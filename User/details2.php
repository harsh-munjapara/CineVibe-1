					...
					<div class="item item--details">
						...
						<div class="item__content">
							...
							<ul class="item__meta item__meta--second">
								<li><span>Director:</span> <a href="actor.php">Louis Leterrier</a></li>
								<li><span>Actors:</span> <a href="actor.php">Son Gun</a> <a href="actor.php">Michelle Rodriguez</a> <a href="actor.php">Jordana Brewster</a> <a href="actor.php">Tyreese Gibson</a> <a href="actor.php">Charlize Theron</a></li>
							</ul>
						</div>
				...
				<div class="col-12 col-xl-6">
					...
					<div class="section__item-filter">
						...
						<select class="section__item-select" name="sync" id="filter__sync">
							...
							<option value="3">CineVibe</option>
						</select>
					</div>
				</div>
				<!-- end player -->
...
<!-- Mirrored from CineVibe.volkovdesign.com/main/details2.php by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 29 Feb 2024 13:27:54 GMT -->
</html>