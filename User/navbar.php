				...
				<div class="col-12">
					<div class="header__content">
						...
						<div class="header__categories">
							...
							<div class="dropdown-menu header__dropdown-menu header__dropdown-menu--categories">
								<ul class="header__categories-list">
									<li><a href="catalog1.php">Films</a></li>
									<li><a href="catalog2.php">TV Series</a></li>
									<li><a href="catalog1.php">Anime</a></li>
									<li><a href="catalog2.php">Cartoons</a></li>
								</ul>
								<ul class="header__categories-list">
									<li><a href="catalog1.php">Catalog Grid</a></li>
									<li><a href="catalog2.php">Catalog List</a></li>
									<li><a href="details1.php">Details Film</a></li>
						...
						<ul class="header__nav">
                            <li class="header__nav-item"><a class="header__nav-link" href="index2.php">Home</a></li>
							<!-- dropdown -->
							...
							<li class="header__nav-item">
								<a href="pricing.php" class="header__nav-link">Pricing plans</a>
							</li>
