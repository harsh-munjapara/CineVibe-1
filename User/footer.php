		...
		<div class="container">
			<div class="row">
					...
					<div class="row">
						...
						<div class="col-6">
							<ul class="footer__list">
								<li><a href="catalog1.php">Movies</a></li>
								<li><a href="catalog1.php">TV Shows</a></li>
								<li><a href="catalog1.php">Anime</a></li>
								<li><a href="catalog1.php">Cartoons</a></li>
							</ul>
						</div>

						<div class="col-6">
							<ul class="footer__list">
								<li><a href="catalog1.php">Netflix</a></li>
								<li><a href="catalog1.php">Marvel</a></li>
								<li><a href="catalog1.php">DC Comics</a></li>
								<li><a href="catalog1.php">Book adaptations</a></li>
							</ul>
						</div>
					</div>
				</div>
				...
				<div class="col-6 order-md-4 col-md-4 col-lg-3 col-xl-2">
					...
					<ul class="footer__list">
						<li><a href="privacy.php">Account & Billing</a></li>
						<li><a href="privacy.php">Plans & Pricing</a></li>
						<li><a href="privacy.php">Supported devices</a></li>
						<li><a href="privacy.php">Accessibility</a></li>
					</ul>
				</div>
			</div>
			...
			<div class="row">
				...
				<div class="col-12">
					<div class="footer__copyright">
						<small>© CineVibe, 2023—2024.</small>
