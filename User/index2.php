...
<!-- Mirrored from CineVibe.volkovdesign.com/main/index2.php by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 29 Feb 2024 13:27:54 GMT -->
<head>
	<meta charset="utf-8">
...
<body>
							...
							<ul class="splide__list">
								<li class="splide__slide">
									<div class="hero__slide" data-bg="img/bg/slide__bg-1.jpg">
										<div class="hero__content">
											<h2 class="hero__title">Mind Blowing Suggestions <sub>9.8</sub></h2>
											<p class="hero__text">Welcome to CineVibe, your ultimate destination for unlocking the pulse of captivating content! At CineVibe, we specialize in curating suggestions that resonate with the rhythm of your audience, transforming your digital presence into an unforgettable cinematic experience.</p>
											<p class="hero__category">
												<a href="#">Motivetional</a>
												<a href="#">spiritual</a>
												<a href="#">Comparision</a>
											</p>
											<div class="hero__actions">
												<a href="details.php" class="hero__btn">
								...
								<li class="splide__slide">
									<div class="hero__slide" data-bg="img/bg/slide__bg-2.jpg">
										<div class="hero__content">
											<h2 class="hero__title">Online Content Streaming <sub>7.1</sub></h2>
											<p class="hero__text">Welcome to the future of entertainment at your fingertips! Dive into a world of unlimited possibilities with our Online Streaming platform. Experience seamless access to a vast library of captivating movies, TV shows, and exclusive content, all curated for your ultimate viewing pleasure.</p>
											<p class="hero__category">
												<a href="#">Adventure</a>
												<a href="#">Web series</a>
											</p>
								...
								<li class="splide__slide">
									<div class="hero__slide" data-bg="img/bg/slide__bg-3.jpg">
										<div class="hero__content">
											<h2 class="hero__title">Endless Downloading <sub>8.6</sub></h2>
											<p class="hero__text">Welcome to the era of limitless content at your fingertips! With our Content Downloading service, enjoy the freedom to access your favorite movies, shows, and more, whenever and wherever suits you best.</p>
											<p class="hero__category">
												<a href="#">Drama</a>
												<a href="#">Movies</a>
												<a href="#">Anime</a>
	...
	<section class="content">
				...
				<div class="row">
					<div class="col-12">
						...
						<ul class="nav nav-tabs content__tabs" id="content__tabs" role="tablist">
							...
							<li class="nav-item" role="presentation">
								<button id="2-tab" data-bs-toggle="tab" data-bs-target="#tab-2" type="button" role="tab" aria-controls="tab-2" aria-selected="false">Motivetional</button>
							</li>

							<li class="nav-item" role="presentation">
								<button id="3-tab" data-bs-toggle="tab" data-bs-target="#tab-3" type="button" role="tab" aria-controls="tab-3" aria-selected="false">Movies</button>
							</li>
							...
							<li class="nav-item" role="presentation">
								<button id="5-tab" data-bs-toggle="tab" data-bs-target="#tab-5" type="button" role="tab" aria-controls="tab-5" aria-selected="false">Drama</button>
							</li>

							<li class="nav-item" role="presentation">
								<button id="5-tab" data-bs-toggle="tab" data-bs-target="#tab-5" type="button" role="tab" aria-controls="tab-5" aria-selected="false">TV Shows</button>
							</li>

							<li class="nav-item" role="presentation">
								<button id="6-tab" data-bs-toggle="tab" data-bs-target="#tab-6" type="button" role="tab" aria-controls="tab-6" aria-selected="false">Web Series</button>
							</li>

							<li class="nav-item" role="presentation">
								<button id="7-tab" data-bs-toggle="tab" data-bs-target="#tab-7" type="button" role="tab" aria-controls="tab-7" aria-selected="false">Spiritual</button>
							</li>
						</ul>
		...
		<div class="container">
					...
					<div class="row">
						...
						<div class="col-6 col-sm-4 col-lg-3 col-xl-2">
							<div class="item">
								...
								<div class="item__content">
									<h3 class="item__title"><a href="details1.php">Midnight Sun</a></h3>
									<span class="item__category">
										<a href="#">Comedy</a>
									</span>
									<span class="item__rate">7.1</span>
						...
						<div class="col-6 col-sm-4 col-lg-3 col-xl-2">
							<div class="item">
								...
								<div class="item__content">
									<h3 class="item__title"><a href="details1.php">The Shadow Hunter</a></h3>
									<span class="item__category">
										<a href="#">Romance</a>
										<a href="#">Drama</a>
										<a href="#">Music</a>
						...
						<div class="col-6 col-sm-4 col-lg-3 col-xl-2">
							<div class="item">
								...
								<div class="item__content">
									<h3 class="item__title"><a href="details1.php">Wild Hearts</a></h3>
									<span class="item__category">
										<a href="#">Comedy</a>
										<a href="#">Drama</a>
									</span>
						...
						<div class="col-6 col-sm-4 col-lg-3 col-xl-2">
							<div class="item">
								...
								<div class="item__content">
									<h3 class="item__title"><a href="details1.php">Electric Dreams</a></h3>
									<span class="item__category">
										<a href="#">Comedy</a>
									</span>
									<span class="item__rate">7.1</span>
						...
						<div class="col-6 col-sm-4 col-lg-3 col-xl-2">
							<div class="item">
								...
								<div class="item__content">
									<h3 class="item__title"><a href="details1.php">Broken Promises</a></h3>
									<span class="item__category">
										<a href="#">Action</a>
										<a href="#">Triler</a>
									</span>
						...
						<div class="col-6 col-sm-4 col-lg-3 col-xl-2">
							<div class="item">
								...
								<div class="item__content">
									<h3 class="item__title"><a href="details1.php">Fierce Grace</a></h3>
									<span class="item__category">
										<a href="#">Comedy</a>
										<a href="#">Drama</a>
									</span>
						...
						<div class="col-6 col-sm-4 col-lg-3 col-xl-2">
							<div class="item">
								...
								<div class="item__content">
									<h3 class="item__title"><a href="details1.php">Burning Bridges</a></h3>
									<span class="item__category">
										<a href="#">Romance</a>
										<a href="#">Drama</a>
										<a href="#">Music</a>
						...
						<div class="col-6 col-sm-4 col-lg-3 col-xl-2">
							<div class="item">
								...
								<div class="item__content">
									<h3 class="item__title"><a href="details1.php">Forbidden Love</a></h3>
									<span class="item__category">
										<a href="#">Comedy</a>
										<a href="#">Drama</a>
									</span>
						...
						<div class="col-6 col-sm-4 col-lg-3 col-xl-2">
							<div class="item">
								...
								<div class="item__content">
									<h3 class="item__title"><a href="details1.php">The Timekeeper's Daughter</a></h3>
									<span class="item__category">
										<a href="#">Action</a>
										<a href="#">Triler</a>
									</span>
						...
						<div class="col-6 col-sm-4 col-lg-3 col-xl-2">
							<div class="item">
								...
								<div class="item__content">
									<h3 class="item__title"><a href="details1.php">The Enchanted Forest</a></h3>
									<span class="item__category">
										<a href="#">Comedy</a>
									</span>
									<span class="item__rate">7.1</span>
						...
						<div class="col-6 col-sm-4 col-lg-3 col-xl-2">
							<div class="item">
								...
								<div class="item__content">
									<h3 class="item__title"><a href="details1.php">Relentless</a></h3>
									<span class="item__category">
										<a href="#">Romance</a>
										<a href="#">Drama</a>
										<a href="#">Music</a>
					...
					<div class="row">
						...
						<div class="col-6 col-sm-4 col-lg-3 col-xl-2">
							<div class="item">
								...
								<div class="item__content">
									<h3 class="item__title"><a href="details1.php">Starlight Chronicles</a></h3>
									<span class="item__category">
										<a href="#">Romance</a>
										<a href="#">Drama</a>
										<a href="#">Music</a>
						...
						<div class="col-6 col-sm-4 col-lg-3 col-xl-2">
							<div class="item">
								...
								<div class="item__content">
									<h3 class="item__title"><a href="details1.php">Rising Sun Academy</a></h3>
									<span class="item__category">
										<a href="#">Comedy</a>
										<a href="#">Drama</a>
									</span>
						...
						<div class="col-6 col-sm-4 col-lg-3 col-xl-2">
							<div class="item">
								...
								<div class="item__content">
									<h3 class="item__title"><a href="details1.php">Eternal Bonds</a></h3>
									<span class="item__category">
										<a href="#">Action</a>
										<a href="#">Triler</a>
									</span>
						...
						<div class="col-6 col-sm-4 col-lg-3 col-xl-2">
							<div class="item">
								...
								<div class="item__content">
									<h3 class="item__title"><a href="details1.php">Chronicles of the Elements</a></h3>
									<span class="item__category">
										<a href="#">Comedy</a>
									</span>
									<span class="item__rate">7.1</span>
						...
						<div class="col-6 col-sm-4 col-lg-3 col-xl-2">
							<div class="item">
								...
								<div class="item__content">
									<h3 class="item__title"><a href="details1.php">Fantasia Journey</a></h3>
									<span class="item__category">
										<a href="#">Action</a>
										<a href="#">Triler</a>
									</span>
						...
						<div class="col-6 col-sm-4 col-lg-3 col-xl-2">
							<div class="item">
								...
								<div class="item__content">
									<h3 class="item__title"><a href="details1.php">Phoenix's Destiny</a></h3>
									<span class="item__category">
										<a href="#">Comedy</a>
									</span>
									<span class="item__rate">7.1</span>
						...
						<div class="col-6 col-sm-4 col-lg-3 col-xl-2">
							<div class="item">
								...
								<div class="item__content">
									<h3 class="item__title"><a href="details1.php">Guardians of the Lost City</a></h3>
									<span class="item__category">
										<a href="#">Romance</a>
										<a href="#">Drama</a>
										<a href="#">Music</a>
						...
						<div class="col-6 col-sm-4 col-lg-3 col-xl-2">
							<div class="item">
								...
								<div class="item__content">
									<h3 class="item__title"><a href="details1.php">Divine Intervention</a></h3>
									<span class="item__category">
										<a href="#">Comedy</a>
										<a href="#">Drama</a>
									</span>
						...
						<div class="col-6 col-sm-4 col-lg-3 col-xl-2">
							<div class="item">
								...
								<div class="item__content">
									<h3 class="item__title"><a href="details1.php">Infinite Horizon</a></h3>
									<span class="item__category">
										<a href="#">Romance</a>
										<a href="#">Drama</a>
										<a href="#">Music</a>
						...
						<div class="col-6 col-sm-4 col-lg-3 col-xl-2">
							<div class="item">
								...
								<div class="item__content">
									<h3 class="item__title"><a href="details1.php">Beyond the Stars</a></h3>
									<span class="item__category">
										<a href="#">Comedy</a>
										<a href="#">Drama</a>
									</span>
						...
						<div class="col-6 col-sm-4 col-lg-3 col-xl-2">
							<div class="item">
								...
								<div class="item__content">
									<h3 class="item__title"><a href="details1.php">Shadows of the Past</a></h3>
									<span class="item__category">
										<a href="#">Action</a>
										<a href="#">Triler</a>
									</span>
						...
						<div class="col-6 col-sm-4 col-lg-3 col-xl-2">
							<div class="item">
								...
								<div class="item__content">
									<h3 class="item__title"><a href="details1.php">Wings of Freedom</a></h3>
									<span class="item__category">
										<a href="#">Comedy</a>
									</span>
									<span class="item__rate">7.1</span>
			...
			<div class="row">
				<div class="col-12">
					<a href="catalog1.php" class="section__btn"><span>to catalog</span></a>
				</div>
			</div>
		</div>
	</section>
			...
			<div class="row">
				...
				<div class="col-12 col-md-6 col-lg-4 order-md-2 order-lg-1">
					<div class="plan">
						...
						<ul class="plan__list">
							...
							<li>Limited Downloads (7 per week)</li>
							<li>500 kbps slow Speed</li>
							<li>Limited Support</li>
						</ul>
						<a href="signin.php" class="plan__btn"><span>Register</span></a>
					</div>
				</div>
				<!-- end price -->
				...
				<div class="col-12 col-lg-4 order-md-1 order-lg-2">
					<div class="plan plan--premium">
						...
						<span class="plan__price">₹199</span>
						<ul class="plan__list">
							<li>1 Month</li>
							<li>Full HD</li>
							<li>Unlimited Downloads (49 per week)</li>
							<li>2 mbps fast Speed</li>
							<li>24/7 Support</li>
						</ul>
				...
				<div class="col-12 col-md-6 col-lg-4 order-md-3 order-lg-3">
					<div class="plan">
						...
						<span class="plan__price">₹399</span>
						<ul class="plan__list">
							<li>2 Months</li>
							<li>Ultra HD</li>
					...
					<form action="#" class="modal__form">
						...
						<div class="sign__group">
							...
							<select class="sign__select" name="value" id="value">
								<option value="20">Premium - ₹199</option>
								<option value="40">Cinematic - ₹399</option>
							</select>
...
<!-- Mirrored from CineVibe.volkovdesign.com/main/index2.php by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 29 Feb 2024 13:27:57 GMT -->
</html>