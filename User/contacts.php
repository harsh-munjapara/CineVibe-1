					...
					<div class="row">
						<div class="col-12">
							...
							<ul class="contacts__list">
								...
								<li><a href="mailto:support@CineVibe.com">support@CineVibe.com</a></li>
							</ul>
							...
							<ul class="contacts__social">
								...
								<li><a href="#"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M20.47,2H3.53A1.45,1.45,0,0,0,2.06,3.43V20.57A1.45,1.45,0,0,0,3.53,22H20.47a1.45,1.45,0,0,0,1.47-1.43V3.43A1.45,1.45,0,0,0,20.47,2ZM8.09,18.74h-3v-9h3ZM6.59,8.48h0a1.56,1.56,0,1,1,0-3.12,1.57,1.57,0,1,1,0,3.12ZM18.91,18.74h-3V13.91c0-1.21-.43-2-1.52-2A1.65,1.65,0,0,0,12.85,13a2,2,0,0,0-.1.73v5h-3s0-8.18,0-9h3V11A3,3,0,0,1,15.46,9.5c2,0,3.45,1.29,3.45,4.06Z"></path></svg></a></li>
							</ul>
						</div>
					</div>
				</div>
								...
								<div class="row">
									<div class="col-12 col-xl-6">
										<div class="sign__group">
											<input type="text" class="sign__input" placeholder="Your Name">
										</div>
									</div>
									...
									<div class="col-12">
										<div class="sign__group">
											<input type="text" class="sign__input" placeholder="Subject">
										</div>
									</div>
...
<!-- Mirrored from CineVibe.volkovdesign.com/main/contacts.php by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 29 Feb 2024 13:27:59 GMT -->
</html>